...
<html lang="en">
  ...
  <script src="https://code.jquery.com/ui/1.13.1/jquery-ui.js"></script>
	...
	<script src="https://kit.fontawesome.com/931729f17a.js" crossorigin="anonymous"></script>
	<!-- Google font -->
...
$sql = "SELECT nomPro FROM produit";
$result = mysqli_query($conn, $sql);
$availableTags = [];
while ($row = mysqli_fetch_assoc($result)) {
    array_push($availableTags, $row['nomPro']);
}
?>
						...
						<div class="col-md-6">
							<div class="header-search">
								<form  method="POST" action="blank.php">
									<input  class="input" id="search_input"  placeholder="Search here" name="search">
